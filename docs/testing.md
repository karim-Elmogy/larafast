...
(1) change the value of `bootstrap` attribute to `vendor/elmogy/larafast/src/autoload.php` in `phpunit` tag (it's the same as `vendor/autoload.php` but with needed stuff to run the tests correctly in the generated modules and units).
...
<phpunit xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
         ...
         bootstrap="vendor/elmogy/larafast/src/autoload.php"
         colors="true"
>
    <testsuites>
        <testsuite name="Unit">
